    ...
    const [copied, setCopied] = useState(false);
       ...
       return (
           <div className="flex flex-col gap-y-12 mt-20 mx-2 items-center">
               ...
               <span className="text-7xl font-bold text-transparent bg-clip-text bg-no-repeat bg-gradient-to-br from-solana-green to-solana-purple">
                   Based Solana Chad
               </span>

               <div className="flex flex-col gap-4 items-center">
                   <Card className="flex flex-row gap-x-4 p-4 cursor-pointer items-center"
                       onClick={() => {
